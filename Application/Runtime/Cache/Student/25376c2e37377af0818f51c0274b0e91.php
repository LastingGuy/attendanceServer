...
<head>
    ...
    <link href="<?php echo ($res_path); ?>/css/style.css" rel="stylesheet">
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">总 出 勤 率</div>
                <div class="panel-body">
                        <div style="float:left;width:45%">
                            <div style="margin:0 auto; width:176px;">
                                <span class="chart" data-percent="86" >
                                    <span class="percent" style="font-size: 23px;"></span>
                                </span>
                            </div>
                        </div>
                        <div class="jumbotron" style="float:right;width:55%">
                            <h1>Hello, world!</h1>
                            <p>...</p>
...
<script src="<?php echo ($res_path); ?>/js/jquery.easing.min.js"></script>
<script src="<?php echo ($res_path); ?>/js/jquery.easypiechart.min.js"></script>
<script>
    $(function() {
        $('.chart').easyPieChart({
