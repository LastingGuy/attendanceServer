                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <select class="form-control" name="eteacher" id="eteacher">
                                <?php if(is_array($teachers)): $i = 0; $__LIST__ = $teachers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ma): $mod = ($i % 2 );++$i;?><option value="<?php echo ($ma["tid"]); ?>"><?php echo ($ma["tid"]); ?> <?php echo ($ma["tname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                    </div>
